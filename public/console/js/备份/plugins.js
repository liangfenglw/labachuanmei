...
$(function(){
	...
	/*	可用余额 图表	*/
	if( $('#tb4').length > 0 ){
		var myChart3 = echarts.init(document.getElementById('tb4'));
		option3 = {
			...
			series: [
				{
					...
					data:[
						{value:2356636, name:'已完成'},
						{value:2356636, name:'流单'},
						{value:2356636, name:'退还'},
						{value:2356636, name:'预约'},
						{value:1600000, name:'未完成'}
					]
				}
			]
		};
