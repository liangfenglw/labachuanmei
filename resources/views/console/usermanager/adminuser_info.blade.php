...
<div class="content">
    <div class="Invoice">
        ...
        <div class="main_o clearfix" style="padding-bottom:20px;">
            <h3 class="title4 clearfix"><strong><a>管理员详情</a></strong></h3>
            <div class="safe_1 clearfix">
                <div class="wrap_fl clearfix" style="width: 50%">
                    <form action="/usermanager/adminuser/user" method="post">
                        {!! csrf_field() !!}
                        <input type="hidden" name="user_id" value="{{ $id }}">
                        <div class="item_f"><p><i class="LGntas"></i>用户名：</p>
                            <div class="r"><input type="text" name="name" id="textfield" class="txt_f1" style="width:75%;" value="{{ $user_mes['name'] }}"></div>
                        </div>
                        @if($user_mes['role_id'] == 1)
                                ...
                                <div class="r">
                                    <select class="sel_f1" style="min-width:150px;width:50%;" name="level_id" onchange="getCategory(this);">
                                        @foreach($role as $key => $value)
                                            <option value="{{ $value['id'] }}" @if($value['id'] == $user_mes['role_id']) selected="selected" @endif >{{ $value['level_name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                       ...
                       <!--  <div class="item_f"><p><i class="LGntas"></i>原密码：</p>
                            <div class="r"><input type="text" name="oldpwd" id="datepicker3" class="txt_f1" style="width:75%;"></div>
                        </div> -->
                        <div class="item_f"><p><i class="LGntas"></i>新密码：</p>
                            <div class="r"><input type="text" name="newpwd" id="" class="txt_f1" style="width:75%;"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>创建时间：</p>
                            <div class="r">
                                {{ $user_mes['created_at'] }}</div>
                        </div>
