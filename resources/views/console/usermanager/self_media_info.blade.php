...
<div class="content"><div class="Invoice">
    ...
    <div class="main_o clearfix" style="padding-bottom:20px;">
        ...
        <form action="/usermanager/selfMedia" method="post" enctype="multipart/form-data" id="user_form" onsubmit="return sub_form();">
            {{ csrf_field() }}
            <input type="hidden" name="user_id" value="{{ $info['id'] }}">
            <div class="safe_1 clearfix">
                <div class="wrap_fl clearfix" style="width:35%;">
                        <div class="item_f"><p><i class="LGntas"></i>媒体名称：</p>
                            <div class="r"><input type="text" name="media_name" id="media_name" value="{{ $info['supp_user_self']['media_name'] }}" class="txt_f1"  style="width:75%;"></div>
                        </div>
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>媒体LOGO：</p>
                            <div class="r" style="position:relative;">
                                <div class="img_show">
                                    <img src="@if($info['supp_user_self']['media_logo']) {{$info['supp_user_self']['media_logo']}} @else /console/images/z_add2.png @endif" id="img_upload" name="" style="cursor:pointer;float:left;margin-right:8px;width:130px; height:130px;" />
                            ...
                            <div class="r">
                                ...
                                {{-- <select class="sel_f1" style="width:70%;" name="plate_tid" id="plate_tid" onchange="select_child(this);">
                                    ...
                                    @foreach($plate_list as $key => $val)
                                        <option value="{{ $val->id }}" @if($info['supp_user_self']['plate_tid'] == $val->id)selected  @endif>{{ $val->plate_name }}</option>
                                    @endforeach
                                </select> --}}
                            </div>
                        </div>
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>入口示意图：</p>
                            <div class="r" style="position:relative;">
<div class="img_show">
        <img src="@if($info['supp_user_self']['index_logo']) {{$info['supp_user_self']['index_logo']}} @else /console/images/z_add2.png @endif" id="img_upload2" style="cursor:pointer;float:left;margin-right:8px;width:130px; height:130px;" />
    <input type="file" name="index_logo" id="documents_upload_button2" placeholder="未选择任何文件"  class="txt6 txt6_up upfile upload_f1" style="width:130px;height:130px;display:none;opacity:0;"     accept="image/jpg,image/jpeg,image/png" />
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>价格：</p>
                            <div class="r">
                                <input  type="text" name="proxy_price" value="{{ $info['supp_user_self']['proxy_price'] }}" class="txt_f1" style="width:40%;" id="proxy_price"><span class="color1" style="padding-left:10px;">元</span>
                            </div>
                        </div>
                        <div class="item_f">
                        <p><i class="LGntas"></i>会员价率：</p>
                        <div class="r">
                            <input type="text" name="vip_rate" id="vip_price" value="{{ $info['supp_user_self']['vip_rate'] }}" onkeyup="setPrice();" class="txt_f1"><span class="color1" style="padding-left:10px;">%</span>
                        </div>
                    </div>
                    <div class="item_f">
                        <p><i class="LGntas"></i>平台价率：</p>
                        <div class="r">
                            <input type="text" name="plate_rate" id="plate_price" value="{{ $info['supp_user_self']['plate_rate'] }}" onkeyup="setPrice();" class="txt_f1"><span class="color1" style="padding-left:10px;">%</span>
                        </div>
                    </div>
                        <div class="item_f"><p><i class="LGntas"></i>会员价：</p>
                            <div class="r">
                                <input type="text" name="vip_price" id="vips_price" value="{{ $info['supp_user_self']['vip_price'] }}" readonly="readonly" class="txt_f1"><span class="color1" style="padding-left:10px;">元</span>
                            </div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>平台价：</p>
                            <div class="r">
                                <input type="text" name="plate_price" value="{{ $info['supp_user_self']['plate_price'] }}" id="plates_price" readonly="readonly" class="txt_f1"><span class="color1" style="padding-left:10px;">元</span>
                            </div>
                        </div>
                </div>
                <div class="wrap_fr" style="width:47%;margin-right:2%;">
                    <div class="wrap_fr3">
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>负责人：</p>
                            <div class="r"><input type="text" name="media_contact" id="media_contact" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['media_contact'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>联系电话：</p>
                            <div class="r"><input type="text" name="contact_phone" id="contact_phone" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['contact_phone'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>电子邮箱：</p>
                            <div class="r"><input type="text" name="email" id="email" class="txt_f1" style="width:75%;"  value="{{ $info['supp_user_self']['email'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>联系QQ：</p>
                            <div class="r"><input type="text" name="qq" id="qq" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['qq'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>联系地址：</p>
                            <div class="r"><input type="text" name="address" id="address" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['address'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>邮编：</p>
                            <div class="r"><input type="text" name="zip_code" id="zip_code" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['zip_code'] }}"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>网站/微博：</p>
                            <div class="r"><input type="text" name="web_contact" id="web_contact" class="txt_f1" style="width:75%;" value="{{ $info['supp_user_self']['web_contact'] }}"></div>
                        </div>
                    </div>
                </div>
                <div class="clr"></div>
                ...
                <div class="main_o clearfix" style="padding-bottom:0;width:90%;border:none;box-shadow: 0px 0px 0px #fff;">
                    ...
                    <div class="clearfix">
                        <div class="item_f"><p style="height:128px;line-height:128px;"><i class="LGntas"></i>媒体优势：</p>
                            <div class="r">
                                <textarea class="txt_ft1"  name="remark" id="remark" style="width:70%;height:128px;" >{{ $info['supp_user_self']['remark'] }}</textarea>
                            </div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>状态：</p>
                            <div class="r radio_w">
                                 <label class="rd1 @if($info['supp_user_self']['is_state'] == 1) css_cur @endif"><input type="radio" name="is_state" @if($info['supp_user_self']['is_state'] == 1) checked @endif class="radio_f" value="1" />在线</label>
                                <label class="rd1 @if($info['supp_user_self']['is_state'] == 2) css_cur @endif"><input type="radio" name="is_state" @if($info['supp_user_self']['is_state'] == 2) checked @endif class="radio_f" value="2" />下架</label>
                                <label class="rd1 @if($info['supp_user_self']['is_state'] == 3) css_cur @endif"><input type="radio" name="is_state" @if($info['supp_user_self']['is_state'] == 3) checked @endif class="radio_f" value="3" />审核</label>
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success:function(msg) {
                    ...
                    if (msg.status_code == 200) {
                        for (i in msg.lists) {
                            if (msg['lists'][i]['id'] == "{{$info['supp_user_self']['plate_id']}}") {
