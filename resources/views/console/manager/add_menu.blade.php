        ...
        <div class="clearfix wrap_f" style="">
            <form action="/manager/updateCategory" method="post" id="myform">
                ...
                <div class="item_f"><p><i class="LGntas"></i>是否显示：</p>
                    <div class="r radio_w">
                        <label class="rd1"><input type="radio" name="is_show" class="radio_f" value="1" />显示</label>
                        <label class="rd1"><input type="radio" name="is_show" class="radio_f" value="2" />隐藏</label>
                    </div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>名称：</p>
                    <div class="r"><input type="text" name="menu" id="textfield" class="txt_f1" style="width:52%;" /></div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>ico图标：</p>
                    <div class="r"><input type="text" name="ico" id="textfield" class="txt_f1" style="width:60%;" /></div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>路由：</p>
                    <div class="r"><input type="text" name="route" id="textfield" class="txt_f1" style="width:60%;" /></div>
                </div>
