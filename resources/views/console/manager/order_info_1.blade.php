        ...
        @endif
                @if(in_array($info['order_type'], [14,15]))
                ...
                @endif
                @if(in_array($info['order_type'], [12]) && $info['deal_with_status'] == 0)
                    <div class="item_f item_f_2" style="margin-top:20px;">
                        <div class="r"><input type="button" value="进行中" class="sub5" style="margin-left:0;"></div>
                    </div>
                @else {{-- 申请退款 --}}
                    <div class="item_f item_f_2" style="margin-top:20px;">
