...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		 <div class="place_ant"><a href="/">首页</a> <a href="{{url('userpersonal/person_edit')}}"  class="cur">用户信息 </a></div>
	</div>
	
	<div class="main_s">
		<h3 class="title3"><strong>用户资料</strong>
        	<p style="font-size:14px; text-align:right; line-height:75px;">资料更完整，账号更安全。完善资料将帮助我们更好的提供服务。</p>
        </h3>
		<div class="safe_1 clearfix" style="margin: 0 auto 0;">
			<div class=" wrap_f clearfix">
...
<div class="img_show">
	<img src="@if($user['head_pic']!='') {{$user['head_pic']}} @else {{url('console/images/z_add2.png')}} @endif" id="img_upload"  style="cursor:pointer;float:left;margin-right:8px;width:130px; height:130px;" />
	<input type="file" name="head_pic" id="documents_upload_button" onchange="loadImage(this)" placeholder="未选择任何文件" class="txt6 txt6_up upfile upload_f1" accept="image/jpg,image/jpeg,image/png" style="width:130px;height:130px;display:none;opacity:0;"	/>
</div>
