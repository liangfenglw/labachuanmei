...
<div class="content"><div class="Invoice">
	...
	<div class="main_s">
		<h3 class="title3"><strong>安全设置</strong></h3>
		<div class="safe_1">
					<div class="safe_1_t clearfix">
						<img src="{{url('console/images/avatar.png')}}" class="l" style="width:120px; height:120px;">
						<div class="r">
							<p>会员帐号：{{$user['name']}}</p>
					...
					<div class="safe_1_m clearfix">
						...
						<span class="r"><i>{{$safe_type}}</i></span>
					...
					<div class="safe_1_b">
						<ul class="ul_table1">
							...
							<li><span class="sp1">绑定邮箱</span>
								...
								<span class="sp4">
									<a href="person_safe_email">@if($user['email'])修改@else设置@endif</a>
								</span>
							</li>
