...
<div class="s1_tab">
    <ul class="clearfix">
        @if($level_id == 2)
        <li class="@if($active == 'user_manage')cur @endif"><a href="/userpersonal/user_manage">会员管理</a></li>
        @endif
...
-->
        <li class="@if($active == 'person_edit' or $active == 'person_safe')cur @endif"><a href="/userpersonal/person_safe">安全设置</a></li>
        <li class="@if($active == 'supp_edit')cur @endif"><a href="{{url('supp/supp_edit')}}">用户信息</a></li>
        <li class="@if($active == 'resource')cur @endif"><a href="{{url('supp/resource')}}">媒体管理</a></li>
    </ul>
</div>
@endif
