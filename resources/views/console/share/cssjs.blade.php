    ...
    <link href="/console/css/style2.css?v=1.0" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="/console/js/jquery.touchslider.min.js"></script>
    ...
    <!-- 公共自定义js -->
    <script type="text/javascript" src="/console/js/public.js?v=2.1"></script>    
