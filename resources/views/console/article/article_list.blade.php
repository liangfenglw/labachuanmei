...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
         <div class="place_ant"><a href="/">首页</a><a  href="/console/article/manager" class="cur">文章管理 </a></div>
    </div>
                    ...
                    <tbody id="listcontent">
                        @foreach($article_list as $key => $val)
                            <tr>
                                ...
                                <td>{{ $val['origin'] }}</td>
                                <td><a class="color2" href="/console/article/{{ $val['id'] }}">查看</a> <span class="color2">|</span> <a class="color2 del2" data-id="{{ $val['id'] }}" href="javascript:;">删除</a></td>
                            </tr>
                        @endforeach
