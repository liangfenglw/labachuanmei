...
<div class="content"><div class="Invoice">
    ...
    <div class="main_o" style="padding-bottom:50px;">
        <h3 class="title4"><strong><a href="javascript:;">添加文章分类</a></strong></h3>
        <div class="clearfix wrap_f" style="">
            <form action="" method="post" onsubmit="return checkForm();">
                ...
                <div class="item_f"><p><i class="LGntas"></i>分类名称：</p>
                    <div class="r"><input type="text" name="category_name" id="category_name" class="txt_f1" style="width:40%;" /></div>
                </div>
                <div class="item_f"><p><i class="LGntas"></i>分类排序：</p>
                    <div class="r"><input type="text" name="sortorder" id="sortorder" class="txt_f1" style="width:16%;" placeholder="默认99，降序" /></div>
                </div>
                <div class="item_f"><p><i class="LGntas"></i>状态：</p>
                    <div class="r radio_w">
                        <label class="rd1 css_cur"><input type="radio" name="status" class="radio_f" checked value="1" />在线</label>
