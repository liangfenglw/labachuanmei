...
<div class="content"><div class="Invoice">
	...
	<div class="main_o clearfix">
		...
		<div class="w_success clearfix" style="width:630px;">
			<div class="w_success_t clearfix">
				<img src="{{url('console/images/yes.png')}}" />
				<div>
					<h3>交易成功</h3>
					<p>感谢您使用喇叭传媒平台支付</p>
				</div>
			...
			<div class="w_success_m">
				...
				<p>您可能需要：<a href="/userpersonal/account_query">查看余额</a>|<a href="/userpersonal/account_query">消费记录</a>|<a href="/userpersonal/onlnetop_up">我要充值</a>|<a href="/order/apply_invoice">申请发票</a>|<a href="/cart/cart_list">返回继续下单</a></p>
			</div>
		</div>
