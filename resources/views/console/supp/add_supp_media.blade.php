...
<div class="content"><div class="Invoice">
    ...
    <div class="main_o clearfix" style="padding-bottom:20px;">
        ...
        <form action="/usermanager/saveSuppMedia" method="post" enctype="multipart/form-data" id="user_form" onsubmit="return sub_form();">
            {{ csrf_field() }}
