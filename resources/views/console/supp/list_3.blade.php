...
.list_3 ul li{		float:left;	width:350px;	font-size:16px;	line-height:36px;	margin:13px 10px;	}
.list_3 ul li strong{	font-weight:400;	}
.list_3 ul li span{		}
.list_3 ul li .txt_f1{		width:50%;	padding:0 15px;	}
...
<div class="content"><div class="Invoice">
	...
	<div class="place">
        <div class="place_ant"><a href="/console/index">首页</a> <a class="cur">媒体价格管理</a> </div>
        
    </div>
	
    <div class="main_o clearfix" style="padding-bottom:0;margin-bottom:20px;">
	
		<h3 class="title4 clearfix"><strong><a href="#">媒体价格管理</a></strong></h3>
			
		<div class="list_3">
			<form action="" method="" class="" id="">
				<ul class="clearfix">
					<li><strong>平台价率：</strong>
						<span><input type="text" name="belong" value="" id="textfield" class="txt_f1" ></span></li>
					<li><strong>平台价：</strong>
						<span class="color1"><input type="text" name="belong" value="" id="textfield" class="txt_f1" ></span></li>
					<li class="clr"><strong>会员价率：</strong>
						<span><input type="text" name="belong" value="" id="textfield" class="txt_f1" ></span></li>
					<li><strong>会员价：</strong>
						<span class="color1"><input type="text" name="belong" value="" id="textfield" class="txt_f1" ></span></li>
					<li class="clr"><input type="submit" value="确 认" class="sub5" style="" /></li>
				</ul>
			</form>
		</div>
...
<table class="table_in1 cur" id="datatable1">
    ...
    <tbody id="listcontent">
		<tr>
			...
			<td></td>
			<td><a class="color2" href="/console/add_view?blade_name=list_4">查看</a> &nbsp;  &nbsp; 
				<label class="color2"><input type="checkbox" name="yunxu_jiedan" class="" value="" /> 允许接单</label>
			</td>
		</tr>
		<tr>
			<td></td>
