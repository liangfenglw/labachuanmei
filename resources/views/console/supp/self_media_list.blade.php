...
<div class="content"><div class="Invoice">
    <div class="place">
        <div class="place_ant"><a href="/console/index">首页</a> <a class="cur">自营媒体管理</a> </div>
        
    </div>
    <div class="main_o clearfix" style="padding-bottom:0;">
        <h3 class="title4 clearfix">
            <strong><a href="#">自营媒体管理</a></strong>
                ...
                <form action="" method="get" name="">
                    <div style="float:right;">
                        ...
                        <div class="l">
                            ...
                            <a class="sub4_2" href="/usermanager/addSelfMedia" style="background:#7db6eb">创建</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <tbody id="listcontent">
                        @foreach($lists as $key => $val)
                            <tr>
                                ...
                                <td class="color1">￥{{ $val['plate_price'] }}</td>
                                <td class="color1">￥{{ $val['vip_price'] }}</td>
                                <td>{{ getSuppUserType($val['is_state']) }}</td>
                                <td>
                                    <a class="color2" href="/usermanager/selfMedia?id={{ $val['user_id'] }}">查看</a>
                                    <a class="color2" href="/usermanager/sameTypeMedia?id={{ $val['user_id'] }}">同类媒体</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
/*  日历  */
    ...
    function get_excel()
    {
        var hrefs = '/usermanager/selfMediaList?get_excel=1';
