...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
         <div class="place_ant"><a href="/console/index">首页</a><a  class="cur">会员详情 </a></div>
    </div>
    ...
    <div class="main_o clearfix" style="padding-bottom:20px;">
        ...
        <div class="tab2">
            <ul class="clearfix" style="float:left;">
                <li class="cur"><a href="javascript:void(0);">会员详情</a></li>
                @if($info['level_id'] >= 2) <li class=""><a href="/user/daili_user_list?pid={{ $info['user_id'] }}">代理会员</a></li>
                @endif
            </ul>
        </div>
            ...
            <div class="wrap_fl clearfix" style="width:35%;">
                ...
                <form action="/user/ad_user/update" method="post">
                    ...
                    <div class="item_f"><p><i class="LGntas"></i>用户名：</p>
                        <div class="r">
                        <input type="text" name="" id="textfield" class="txt_f1" style="width:75%;" value="{{ $info['user']['name'] }}"></div>
                    </div>
<!--
...
-->
                    <div class="item_f"><p><i class="LGntas"></i>创建时间：</p>
                        <div class="r"><input type="text" name="textfield" id="" class="txt_f1" style="width:75%;" value="{{ $info['created_at'] }}" readonly="readonly"></div>
                    </div>
                    ...
                    <div class="item_f"><p><i class="LGntas"></i>企业名称：</p>
                        <div class="r"><input type="text" value="{{ $info['company'] }}" name="company" id="textfield" class="txt_f1" style="width:75%;"></div>
                    </div>
                    <div class="item_f">
                        <p><i class="LGntas"></i>简介：</p>
                        <div class="r">
                             <textarea class="txt_ft1"  name="breif" id="breif" style="width:70%;height:128px;" >{{ $info['breif'] }}</textarea>
                         </div>
                         </div>
