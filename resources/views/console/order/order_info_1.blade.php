        ...
        <div class="clearfix wrap_f" style="padding-bottom:50px;">
            ...
            {{ csrf_field() }}
                ...
                <div class="item_f" style="display:none;"><p><i class="LGntas"></i>供应商：</p>
                    <div class="r">
                        <input type="text" name="textfield" id="textfield" disabled="disabled" class="txt_f1" value="{{ $info['parent_order']['son_order']['0']['media_name']['media_name'] }}">
                    </div>
                </div>
                ...
                <div class="item_f">
                    <p><i class="LGntas"></i>
                    @if($info['type_id'] == 10) 直播标题@else 稿件名称@endif：</p>
