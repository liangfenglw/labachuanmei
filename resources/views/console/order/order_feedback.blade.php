...
<div class="content"><div class="Invoice">
	...
	<div class="place">
        <div class="place_ant"><a href="/">首页</a><a class="cur">最新受理订单 </a></div>
	</div>
	
	<div class="main_o clearfix" style="padding-bottom:0;min-height:400px">
...
<table class="table_in1 cur" id="datatable1">
	...
	@foreach($order_list as $key=>$value)
		<tr>
			...
			<td><a class="color2" href="javascript:void(0);" onclick="setnotice({{$value['notice_id']}},{{$value['id']}})">查看</a></td>
		</tr>
	@endforeach
