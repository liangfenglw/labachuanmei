<div class="main_o">
        ...
        <div class="clearfix wrap_f" style="padding-bottom:50px;">
            ...
            {{ csrf_field() }} 
                ...
                @endif
                @if(in_array($info['order_type'], [4,11]))
                ...
                @if($info['order_feedback'])
                    ...
                    <p><i class="LGntas"></i>申诉原因：</p>      <!--    当会员需要对订单有异议时    -->
                        <div class="r">
                            <textarea class="txt_ft1" name="order_feedback" style="height:100px;">{{ $info['order_feedback'] }}</textarea>
                        </div>
                    </div>
                @endif
                ...
                <div class="item_f item_f_2" style="margin-left:-157px;">
                    <div class="r"><input id="sub" type="submit" value="进行中" class="sub5"></div>
                </div>
                <script>
