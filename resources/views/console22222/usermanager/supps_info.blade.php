...
<div class="content"><div class="Invoice">
    <div class="place">
        当前位置：<a href="/console/index">首页</a> > <a href="/usermanager/ads_list">供应商列表</a> > 帐户信息
    </div>
            ...
            <div class="safe_1 clearfix">
                <div class="wrap_fl clearfix" style="width:35%;">   
                        <div class="item_f"><p><i class="LGntas"></i>用户名：</p>
                            <div class="r"><input type="text" name="name" id="name" value="{{ $info['supp_user']['name'] }}" class="txt_f1" style="width:75%;"></div>
                        </div>
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>媒体LOGO：</p>
                            <div class="r" style="position:relative;">
                                <img src="@if($info['supp_user']['media_logo']) {{$info['supp_user']['media_logo']}} @else /console/images/z_add2.png @endif" id="img_upload" name="" style="cursor:pointer;float:left;margin-right:8px;width:50%" />
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>入口示意图：</p>
                            <div class="r" style="position:relative;">
                                <img src="@if($info['supp_user']['index_logo']) {{$info['supp_user']['index_logo']}} @else /console/images/z_add2.png @endif" id="img_upload2" style="cursor:pointer;float:left;margin-right:8px;width: 50%" />
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>代理价：</p>
                            <div class="r">
                                <input type="text" name="proxy_price" id="proxy_price" value="{{ $info['supp_user']['proxy_price'] }}"class="txt_f1" style="width:55%;"><span class="color1" style="padding-left:10px;">元</span>
                            </div>
                        </div>
                </div>
                ...
                <div class="wrap_fr" style="width:47%;margin-right:2%;">
                    <div class="wrap_fr3">
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i></p>
                            <div class="r" style="position:relative;">
                                <img src="@if($info['supp_user']['media_check_file']) {{$info['supp_user']['media_check_file']}} @else /console/images/z_add2.png @endif" id="img_upload3" style="cursor:pointer;float:left;margin-right:8px;width:50%" />
                ...
                <div class="main_o clearfix" style="padding-bottom:0;width:90%;border:none;box-shadow: 0px 0px 0px #fff;">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>状态：</p>
                            <div class="r radio_w">
                                <label><input type="radio" name="is_state" @if($info['supp_user']['is_state'] == 1) checked="true" @endif class="radio_f" value="1" />在线</label>
                                <label><input type="radio" name="is_state" @if($info['supp_user']['is_state'] == 2) checked="true" @endif class="radio_f" value="2" />下架</label>
                                <label><input type="radio" name="is_state" @if($info['supp_user']['is_state'] == 3) checked="true" @endif class="radio_f" value="3" />审核</label>
                            </div>
                        </div>
