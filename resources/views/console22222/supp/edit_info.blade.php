...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
        当前位置：<a href="index.php">首页</a> > 帐户信息
    </div>
    <div class="main_o clearfix" style="padding-bottom:20px;">
        <h3 class="title4 clearfix"><strong><a>会员资料</a></strong></h3>
            ...
            <div class="safe_1 clearfix">
                <div class="wrap_fl clearfix" style="width:35%;">   
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>所属媒体：</p>
                            <div class="r"><input type="text" name="belong" value="{{ $info['supp_user']['belong'] }}" id="textfield" class="txt_f1" style="width:75%;" disabled="disabled"></div>
                        </div>
                        <div class="item_f"><p><i class="LGntas"></i>媒体类型：</p>
                            <div class="r">
                                <select class="sel_f1" style="width:70%;" disabled="disabled" name="plate_tid" id="plate_tid" onchange="select_child(this);">
                        ...
                        <div class="item_f"><p><i class="LGntas"></i>媒体分类：</p>
                            <div class="r">
                                <select class="sel_f1" style="width:70%;" disabled="disabled" id="child_class" name="plate_id" onchange="select_attr(this)">
                                    <option value="0">请选择</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>媒体LOGO：</p>
                            <div class="r" style="position:relative;">
                                <img  width="50%" src="{{ $info['supp_user']['media_logo'] }}" id="img_upload" name="" style="cursor:pointer;float:left;margin-right:8px;" />
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>入口示意图：</p>
                            <div class="r" style="position:relative;">
                                <img src="{{ $info['supp_user']['index_logo'] }}" id="img_upload2" style="cursor:pointer;float:left;margin-right:8px;width: 50%" />
                ...
                <div class="wrap_fr" style="width:47%;margin-right:2%;">
                    <div class="wrap_fr3">
                        ...
                        <div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i></p>
                            <div class="r" style="position:relative;">
                                <img src="{{ $info['supp_user']['media_check_file'] }}" id="img_upload3" style="cursor:pointer;float:left;margin-right:8px;width: 50%" />
                                <input type="file" disabled="disabled" name="media_check_file" id="documents_upload_button3" placeholder="未选择任何文件" class="upload_f1" accept="image/*" style="" />
                                <span class="info1_f valign_m" style="height:95px;padding:0;">
                                    <i>*</i> 请点击选择图片，仅支持JPG、JPEG、GIF、PNG格式的图片文件，文件不能大于2MB。
                                </span>
                            </div>
