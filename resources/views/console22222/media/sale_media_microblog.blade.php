								...
								<li style="display:block;">
									...
									<div id="bianji" title="内部编辑" style="display: none;">
										<div class="WMain3 WMain3_1"><p><i class="LGntas">*</i>内容编辑:</p>
											<script id="container" name="content" type="text/plain" style="width:90%;height:300px;width:auto;"></script>
										</div>
									</div>															
				...
				if (data.status == '1') {
					for(var i=0; i< sum; i++){
						...
						data.data[i]['media_name']+'</td><td>'+data.data[i]['publish_type']+'</td>'+
							'<td>'+data.data[i]['fans']+'</td><td class="color1">￥'+data.data[i]['proxy_price']+'</td>'+
