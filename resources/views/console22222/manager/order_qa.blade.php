...
<head>
    ...
    <title>任—订单管理 - 申诉订单详情 - 喇叭传媒</title>
...
<div class="content"><div class="Invoice">
    <div class="place">
        当前位置：<a href="/console/index">首页</a> > <a href="">订单管理</a> > 订单申诉
    </div>
    <div class="main_o">
            ...
            <form action="" method="post" onsubmit="return sub_form();">
                ...
                <div class="item_f"><p><i class="LGntas"></i>订单号：</p>
                    <div class="r">
                        ...
                        <span class="color1" style="padding-left:10px;"><a href="/console/manager/order/info/{{$info['order_id']}}?type=1">订单信息</a></span>
                    </div>
                ...
                <div class="item_f"><p><i class="LGntas"></i>完成截图：</p>
                    <div class="r" style="position:relative;">
                        <img src="{{ $info['success_pic'] }}" style="width:10%">
                    </div>
                </div>
