        ...
        <div class="clearfix wrap_f" style="padding:70px 10px 100px;width:30%;min-width:400px;">
            <form action="/manager/updateCategory" method="post" id="myform">
                ...
                <div class="item_f"><p><i class="LGntas"></i>是否显示：</p>
                    <div class="r radio_w">
                        <label><input type="radio" name="is_show" class="radio_f" value="1" @if($res_data['is_show'] == 1)checked @endif />显示</label>
                        <label><input type="radio" name="is_show" class="radio_f" value="2" @if($res_data['is_show'] == 2)checked @endif />隐藏</label>
                    </div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>名称：</p>
                    <div class="r">
                        <input type="text" name="menu" id="textfield" class="txt_f1" value="{{ $res_data['menu'] }}" style="width:75%;" />
                    </div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>ico图标：</p>
                    <div class="r"><input type="text" name="ico" value="{{ $res_data['ico'] }}" id="textfield" class="txt_f1" style="width:75%;" /></div>
                </div>

                <div class="item_f"><p><i class="LGntas"></i>路由：</p>
                    <div class="r"><input type="text" name="route" value="{{ $res_data['route'] }}" id="textfield" class="txt_f1" style="width:75%;" /></div>
                </div>
