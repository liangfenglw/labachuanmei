...
-->
                ...
                <form action="" method="post">
                    ...
                    <div class="item_f"><p><i class="LGntas"></i>订单号：</p>
                        <div class="r"><input type="text" name="id" id="textfield" class="txt_f1" style="width:38%;" value="{{ $info['id'] }}"></div>
                    </div>
                    <div class="item_f"><p><i class="LGntas"></i>用户名：</p>
                        <div class="r"><input type="text" name="name" id="textfield" class="txt_f1" style="width:38%;" value="{{ $info['users']['name'] }}"></div>
                    </div>
                    <div class="item_f"><p><i class="LGntas"></i>用户角色：</p>
                        <div class="r"><input type="text" name="user_level" id="textfield" class="txt_f1" style="width:16%;" value="@if($info['ads_user'])  @else 供应商  @endif" /></div>
                    </div>
                    ...
                    <div class="item_f"><p><i class="LGntas"></i>状态：</p>
                        <div class="r radio_w">
                            <label><input type="radio" name="status" class="radio_f" value="1" @if($info['status'] == 1) checked @endif/>完成</label>
                            <label><input type="radio" name="status" class="radio_f" value="2" @if($info['status'] == 0) checked @endif/>审核中</label>
                            <label><input type="radio" name="status" class="radio_f" value="3" @if($info['status'] == 2) checked @endif/>拒提现</label>
                        </div>
                    </div>
                    <div class="item_f"><p><i class="LGntas"></i>备注：</p>
                        <div class="r">
                            <textarea class="txt_ft1" style="height:90px;" readonly="readonly">{{ $info['desc'] }}</textarea>
                        </div>
                    </div>
                    @if($info['status'] == 0)
