...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
        当前位置：<a href="/console/index">首页</a> > 广告主列表
    </div>
    
    <div class="main_o clearfix" style="padding-bottom:0;">
    
        <h3 class="title4 clearfix"><strong><a>广告主列表</a></strong>
            <div class="search_1">
<!--
...
-->
                <div style="float:right;">
                    ...
                    <div class="l">
                        <a class="sub4_2" href="javascript:;" onclick="get_excel();">导出明细</a>
                    </div>
                </div>
<!--
                </form>
...
function get_excel()
{
    url = "/user/ajax/ad_user_list?get_excel=1&level_id=1";
