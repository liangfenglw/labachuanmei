        ...
        <div class="clearfix wrap_f" style="padding:70px 10px 100px;width:30%;min-width:400px;">
            <form action="/console/article/category/add" method="post" onsubmit="return checkForm();">
                ...
                <div class="item_f"><p><i class="LGntas"></i>分类名称：</p>
                    <div class="r"><input type="text" name="category_name" id="category_name" class="txt_f1" style="width:75%;" value="{{ $info['category_name'] }}" /></div>
                </div>
                <div class="item_f"><p><i class="LGntas"></i>分类排序：</p>
                    <div class="r"><input type="text" name="sortorder" id="sortorder" class="txt_f1" style="width:75%;" placeholder="默认99，降序" value="{{ $info['sortorder'] }}" /></div>
                </div>
                <div class="item_f"><p><i class="LGntas"></i>状态：</p>
                    <div class="r radio_w">
                        <label><input type="radio" name="status" class="radio_f" @if($info['status'] == 1) checked @endif value="1" />在线</label>
                        <label><input type="radio" name="status" class="radio_f" @if($info['status'] == 2) checked @endif value="2" />下架</label>
                    </div>
                </div>
