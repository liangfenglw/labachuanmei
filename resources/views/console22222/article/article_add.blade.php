...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
        当前位置：<a href="/console/index">首页</a> > 添加文章
    </div>
    
    <div class="main_o" style="padding-bottom:50px;">
        
        <h3 class="title4"><strong><a href="javascript:;">添加文章</a></strong></h3>
        ...
        <div class="clearfix wrap_f" style="padding:50px 10px 30px;width:70%;min-width:400px;">
            ...
            <form action="/console/article/update" method="post">
                ...
                <div class="item_f"><p><i class="LGntas"></i>标题：</p>
                    <div class="r"><input type="text" name="title" id="textfield" class="txt_f1" style="width:75%;" /></div>
                </div>
                <div class="item_f"><p><i class="LGntas"></i>来源：</p>
                    <div class="r"><input type="text" name="origin" id="textfield" class="txt_f1" style="min-width:176px;width:10%;" /></div>
                </div>
                ...
                <div class="item_f" style="display: none" id="child_div"><p><i class="LGntas"></i>发布栏目：</p>
                    <div class="r">
