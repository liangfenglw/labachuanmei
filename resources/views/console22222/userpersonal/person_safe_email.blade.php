...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		当前位置：<a href="/console/index">首页</a> > <a href="/supp/supp_edit">用户信息</a> > <a href="person_safe">安全设置</a>
	</div>
	...
	<div class="main_s">
		...
		<div class="safe_2 clearfix">
			...
			<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>邮箱验证码：</p>
				...
				<input type="submit" name="send_sms_button" id="send_sms_button" value="获取验证码" class="LGn3" style="cursor:pointer;height:37px;line-height:37px;">
			</div>
            @if($user['email'])
