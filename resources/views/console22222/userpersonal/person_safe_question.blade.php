...
<div class="content"><div class="Invoice">
	...
	<div class="main_s">
		<h3 class="title3"><strong>密保设置</strong>
            ...
            {{-- 如果为1 则是重新设置密保 --}}
			<span class="title3_i">@if($security_status == 1) 要先回答正确原密保 @endif</span>
		</h3>
		<div class="safe_2 clearfix">
				...
				<form  method="post" id="question_form" onsubmit="return false;">
					...
					<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>{{$value['name']}}：</p>
						<select class="sel_2" id="question_{{$value['id']}}" name="question[{{$value['id']}}][]" @if($security_status) disabled="disabled"   @endif style="height: 40px; color: #666">
					...
					<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>您的回答：</p>
						<input type="text" name="answer[{{$value['id']}}][]" id="answer_{{$value['id']}}" class="txt6"  style="height: 40px; color: #666">
