			...
			<div class="wrap_f clearfix" style="width:60%;">
				...
				{{ csrf_field() }}
					<div class="item_f"><p><i class="LGntas"></i>用户名：</p>
						<div class="r"><input type="text" name="name" id="name" class="txt_f1" style="width:38%;"></div>
					</div>
					...
					<div class="item_f"><p style="padding-top:25px;"><i class="LGntas"></i>会员头像：</p>
						<div class="r" style="position:relative;">
							<img src="{{url('console/images/z_add2.png')}}" id="img_upload" style="cursor:pointer;float:left;margin-right:8px;" />
							<input type="file" name="head_pic" id="documents_upload_button" placeholder="未选择任何文件" class="upload_f1" accept="image/*" style="" />
					...
					<div class="item_f"><p><i class="LGntas"></i>企业名称：</p>
						<div class="r"><input type="text" name="company" id="company" class="txt_f1" style="width:38%;"></div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>简介：</p>
						<div class="r">
							<textarea class="txt_ft1" name="breif" style="height:90px;width:70%;"></textarea>
						</div>
						<div class="r">
					...
					<div class="item_f"><p><i class="LGntas"></i>联系人：</p>
						<div class="r"><input type="text" name="contact" id="contact" class="txt_f1" style="width:38%;"></div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>联系QQ：</p>
						<div class="r"><input type="text" name="qq" id="qq" class="txt_f1" style="width:38%;"></div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>联系电话：</p>
						<div class="r"><input type="text" name="mobile" id="mobile" class="txt_f1" style="width:38%;"></div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>邮箱：</p>
						<div class="r"><input type="text" name="email" id="email" class="txt_f1" style="width:38%;"></div>
						<div class="r">
							<span class="info1_f"><i>*</i> 请填写有效邮箱地址，以便接受通知及订单信息，建议使用QQ，hotmail等邮箱</span>
						</div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>地址：</p>
						<div class="r"><input type="text" name="address" id="address" class="txt_f1" style="width:38%;"></div>
					</div>
