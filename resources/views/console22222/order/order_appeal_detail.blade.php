...
<div class="content"><div class="Invoice">
    ...
    <div class="place">
        当前位置：<a href="/">首页</a> > <a href="/order/order_list">订单管理</a> > 订单申诉
    </div>
    ...
    <div class="main_o">
        ...
        {{ csrf_field() }} 
                ...
                <div class="item_f"><p><i class="LGntas"></i>活动名称：</p>
                    <div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" disabled="disabled" value="{{ $info['title'] }}" style="width:48%;"></div>
                </div>
                ...
                <div class="item_f"><p><i class="LGntas"></i>完成截图：</p>
                    <div class="r" style="position:relative;">
                        <img src="{{$info['success_pic']}}" id="img_upload" style="cursor:pointer;" />
                ...
                <div class="item_f"><p><i class="LGntas"></i>申诉标题：</p>
                    <div class="r"><input type="text" name="appeal_title" id="appeal_title" disabled="disabled" value="{{ $info['appeal_title'] }}" class="txt_f1" style="width:48%;"></div>
                </div>
