...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx51b4e41a703c8ac1'),         // AppID
    'secret'  => env('WECHAT_SECRET', '22425d72354c32b1bfddf26052c83ddd'),     // AppSecret
     ...
     */
    'payment' => [
        'merchant_id'        => env('WECHAT_PAYMENT_MERCHANT_ID', '1436479602'),
        'key'                => env('WECHAT_PAYMENT_KEY', '5154sdemrs8425rwf5s8es51anteng48'),
        'cert_path'          => env('WECHAT_PAYMENT_CERT_PATH', '/cert.pem'), // XXX: 绝对路径！！！！
